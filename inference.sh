...
model_short_tag="distillr1_qwen3_8b"

model_type="qwen"
tokenizer_path="Qwen/Qwen3-8B"
bos_token="<|im_start|>"
eos_token="<|im_end|>"
compress_config="./configs/LightThinker/qwen/distillr1.json"
...
# model_path="./experiments/distillr1_qwen3_8b/train/checkpoint-5220"
