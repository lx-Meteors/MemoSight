...
# 模型和Tokenizer路径配置
TOKENIZER_PATH="/tmp/hx/Qwen/Qwen3-8B"  # Tokenizer路径
MODEL_PATH="/tmp/hx/Qwen/Qwen3-8B"  # 预训练模型路径
...
#     exit 1
# fi
inference_and_evaluate "vanilla_sepllm" "normal" "inference" "./configs/LightThinker/qwen/v1.json"
