...
# 示例: ./script.sh "anchor-thought" "/tmp/hx/Qwen/Qwen3-8B" "gsm8k" "/tmp/hx/rrcot/lightthinker/inference/gsm8k"
...
if [ $# -lt 4 ]; then
    ...
    echo "示例: $0 \"anchor-thought\" \"/tmp/hx/Qwen/Qwen3-8B\" \"gsm8k\" \"/tmp/hx/rrcot/lightthinker/inference/gsm8k\""
    exit 1
fi
