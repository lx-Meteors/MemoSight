...
This branch targets `Qwen/Qwen3-8B` for Chain-of-Thought inference and
...
```bash
git clone -b CoT-Qwen3 https://github.com/lx-Meteors/MemoSight.git
cd MemoSight
